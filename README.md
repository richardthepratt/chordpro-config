...
In the ChordPro GUI, click Edit > Settings (or Ctrl+R). Under "Presets", check "Custom Configuration File" and select the file you downloaded.

## About ChordPro

[ChordPro](https://www.chordpro.org/) is a simple text format for the notation of lyrics with chords.
